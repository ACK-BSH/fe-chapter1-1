const ProfilePage = userStat => `
<div class='main-content-v2' id='info'>
    ...
    <div class='profile-settings-card-v2'>
      ...
      <div class='profile-form-v2'>
        ...
        <div class='profile-actions-v2'>
          <button class='btn-cancel-v2' id='cancel'>취소</button>
          <button class='btn-save-v2' id='save'>
            <svg width='20' height='20' viewBox='0 0 20 20' fill='none'>
              <path
