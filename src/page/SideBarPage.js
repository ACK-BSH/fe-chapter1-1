const SideBarPage = (userStat) => `
<div class='page dashboard-page-v2' id='side'>
  <div class='sidebar-v2'>
    ...
    <nav class='sidebar-nav-v2'>
      ...
      <button class='nav-item-v2' id='Result'>
        <svg
          width='20'
          height='20'
          viewBox='0 0 24 24'
      ...
      <button class='nav-item-v2 ${userStat.isLogin ? '' : 'hidden'}' id='Profile' >
        <svg
          width='20'
          height='20'
          viewBox='0 0 24 24'
    ...
    <div class='sidebar-footer-v2 ${userStat.isLogin ? '' : 'hidden'}' id='UserStatus'>
